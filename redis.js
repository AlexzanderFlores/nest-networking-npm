...
exports.getUri = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, getKeys_1.default()];
            case 1:
                redis_uri = (_a.sent()).redis_uri;
                return [2 /*return*/, redis_uri];
        }
    });
}); };
var connectToRedis = function () { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, new Promise(function (resolve, reject) { return __awaiter(void 0, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_d) {
                        switch (_d.label) {
                            case 0:
                                _b = (_a = redis_1.default).createClient;
                                _c = {};
                                return [4 /*yield*/, exports.getUri()];
                            case 1:
                                client = _b.apply(_a, [(_c.url = _d.sent(), _c)]);
